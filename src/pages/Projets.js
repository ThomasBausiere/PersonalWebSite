    ...
    return (
        <div className="projets">
            ...
            <div className="article">
                ...
                <h1>Copycat-Gw</h1>
                <p className="description">Alors que je découvrais L'HTML et le CSS, mon formateur m'a conseillé de m'entrainer et de refaire des pages internet.<br/> J'ai été voir un site que j'apprécie et je me suis entrainé. Voici le site de Guild Wars 1. <br/>Mon tout premier projets personnel!</p>
            ...
            <div className="article">            
                ...
                <p className="description">Afin de pratiquer et de produire, j'ai commencé à réaliser des pages reponsives. Je me suis aidé de tutoriels sur youtube (#FrenchCoder) Le but était de m'entrainer et de découvrir certains aspects du mobile first que je n'avais pas encore pratiqué jusqu'alors.<br/>
